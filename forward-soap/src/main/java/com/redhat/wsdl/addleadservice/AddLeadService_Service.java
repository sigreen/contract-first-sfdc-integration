 ...
 * 2019-04-17T12:33:02.453-04:00
 * Generated source version: 3.2.6
 *
 */
@WebServiceClient(name = "AddLeadService",
                  wsdlLocation = "http://localhost:8080/ws/lead?wsdl",
...
public class AddLeadService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/ws/lead?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AddLeadService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/ws/lead?wsdl");
        }
        WSDL_LOCATION = url;
    }
